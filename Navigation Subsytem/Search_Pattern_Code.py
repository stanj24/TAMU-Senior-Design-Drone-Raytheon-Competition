...
#Basic Search Pattern Manuevers for 50 yard/46 meter wide field 
Move_Left(44) #Move 44 meters horizontally to make sure drone doesn't go out the confines of the field 
Move_Straight(4)
Move_Right(44)
Move_Straight(4)
Move_Left(44)
