...
def arm_and_takeoff(aTargetAltitude): #Function for the drone to take off a target altitude
    ...
    while True:
        ...
        if vehicle.location.global_relative_frame.alt >= aTargetAltitude * 0.95:
            ...
            break
        time.sleep(1)
class Continue_movement: #Class that defines all the movement directions
    def __init__(self):
        self.velocity_x = 0
        self.velocity_y = 0
        self.velocity_z = 0
        self.current_loc = [0, 0] #To track the current location of the drone in flight
    ...
    def forward_velocity(self, velocity_x_input, duration_input):#Defines what it means to move forwards
        self.velocity_x = velocity_x_input
        self.velocity_y = 0
        self.velocity_z = 0
        self.duration = duration_input
        msg = vehicle.message_factory.set_position_target_local_ned_encode( #This is the connection code for flight controller to connect to the motors
        ...
        for x in range(0, duration_input):
            ...
            time.sleep(1)
    def backwards_velocity(self, velocity_negative_x_input,duration_input): #Defines what it means to move backwards
        ...
        for x in range(0, duration_input):
            ...
            vehicle.send_mavlink(msg)
            time.sleep(1)
    def right_velocity(self, velocity_right_input,duration_input):#Defines what it means to move right
        self.velocity_x = 0
        ...
        for x in range(0, duration_input):
            ...
            vehicle.send_mavlink(msg)
            time.sleep(1)
    def left_velocity(self, velocity_negative_left_input,duration_input):#Defines what it means to move left
        self.velocity_x = 0
        ...
        for x in range(0, duration_input):
            ...
            vehicle.send_mavlink(msg)
            time.sleep(1)
    def right_diagonol_velocity(self, velocity_diagonol_input,duration_input): #Defines what it means to move right diagonal
        ...
        for x in range(0, duration_input):
            ...
            vehicle.send_mavlink(msg)
            time.sleep(1)
    def left_diagonol_velocity(self, velocity_diagonol_input,duration_input): #Defines what it means to move left diagonal
        self.velocity_x = velocity_diagonol_input
        ...
        for x in range(0, duration_input):
            ...
            vehicle.send_mavlink(msg)
            time.sleep(1)
    def right_neg_diagonol_velocity(self, velocity_diagonol_input,duration_input): #Defines what it means to move negative right diagonal
        self.velocity_x = velocity_diagonol_input
        self.velocity_y = velocity_diagonol_input*-1
        self.velocity_z = 0
        self.duration = duration_input
        ...
        for x in range(0, duration_input):
            ...
            vehicle.send_mavlink(msg)
            time.sleep(1)
    def left_neg_diagonol_velocity(self, velocity_diagonol_input,duration_input): #Defines what it means to negative left diagonal
