...
#Function get the starting location of the drone
    ...
    def upwards_velocity(self,velocity_z_input,duration_input):
        self.velocity_x = 0
        self.velocity_y = 0
    ...
    if p1.loc[1] <15:
        while True:
            if p1.loc[1] >13:
                ...
                p1.right_velocity(3,1) #Testing Value should be 1
    elif p1.loc[1]>15:
        while True:
            if p1.loc[1] >12 and p1.loc[1] <15:
                ...
                p1.left_velocity(3,1) #Testing Value should be 1
    else:
        while True:
            if p1.loc[1] >13:
                print("Nearby Logo y Location")
...
def Search_pattern_left(): #This is defining the boundaries and how the drone moves left in the search pattern technique
    ...
    while True:
            ...
            print("Search pattern left boundary number is",current_y_location_1)
            if current_y_location_1 >48 or current_y_location_1<-48:
                ...
                p1.left_velocity(3, 1) #Testing value should be 2
    if p1.loc[0]>76:
...
def Search_pattern_right(): #This is defining the boundaries and how the drone moves right in the search patttern technique
    ...
    while True:
        ...
        if current_y_location_1 >48 or current_y_location_1<-48:
                ...
                p1.right_velocity(3, 1) #Testing value should be 2
    if p1.loc[0] > 76:
    ...
    if p1.loc[1] > 15:
        ...
        while True:
            if p1.loc[1] == 14 or p1.loc[1] == 15:
                ...
                p1.right_velocity(2,1) #Testing Value
        print("Logo has been identified")
        print("Current location is", p1.loc)
        print("Logo Location is:", logo)
        print("Time to land")
    ...
    if p1.loc[0] > 80:
        while True:
            if p1.loc[0] ==79 or p1.loc[0] ==80:
                ...
                p1.backwards_velocity(3,1) #Testing value should be 1
        homing_sequence_y()
    elif p1.loc[0]<80:
        while True:
            if p1.loc[0] == 79 or p1.loc[0] == 80:
                ...
                p1.forward_velocity(3,1) #Testing value should be 1m/s instead
        homing_sequence_y()
    else:
        print("X coordinate found")
        homing_sequence_y()
